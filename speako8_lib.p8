...
do
	...
	local sounds,current_sound,frication,pitch,cascade,cascade2,formants,open,a,b,b1,v_stress,aspiration,volume={}
			...
			for i=0,127 do
				...
				if source>-1 then
					...
					for k,resonator in pairs(cascade) do
						local f,bw=resonator[1],resonator[2]*(k==1 and spk8_nasal or 1)\10+1 

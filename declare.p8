...
formants=
{
	...
	--	290 610 2150 50 80 60 
		--aw={{2350,80},{610,80},{290,60}},
		--aw={{2350,80,2390,80},{1100,70,900,70},{540,80,450,80}},
...
phone=
{
	...
	aa=
	{
		{280,0,2000,0,0,0,0,formants[1].aa,formants[1].aa},
		{470,2000,0,0,0,0,0,formants[1].aa,formants[1].aa},
	},
	ae=
	{
		{280,0,2000,0,0,0,0,formants[1].ae,formants[1].ae},
		{470,2000,0,0,0,0,0,formants[1].ae,formants[1].ae},
	},
	ah=
	{
		{280,0,2000,0,0,0,0,formants[1].ah,formants[1].ah},
		{470,2000,0,0,0,0,0,formants[1].ah,formants[1].ah},
	},
	ao=
	{
		{280,0,2000,0,0,0,0,formants[1].ao,formants[2].ao},
		{470,2000,0,0,0,0,0,formants[1].ao,formants[2].ao},
	},
	aw=
	{
		{365,1000,2000,0,0,0,0,formants[1].ah,formants[1].ah},
		{1030,2000,1000,0,0,0,0,formants[1].ah,formants[2].aw},
		{300,1000,0,0,0,0,0,formants[2].aw,formants[2].aw},
	},
	ay=
	{
		{150,1000,2000,0,0,0,0,formants[1].ay,formants[1].ay},
		{250,2000,2000,0,0,0,0,formants[1].ay,formants[1].ay},
		{1380,2000,1000,0,0,0,0,formants[1].ay,formants[2].ay},
	},
	eh=
	{
		{320,0,2000,0,0,0,0,formants[1].eh,formants[1].eh},
		{540,2000,0,0,0,0,0,formants[1].eh,formants[1].eh},
	},
	er=
	{
		{280,0,2000,0,0,0,0,formants[1].er,formants[2].er},
		{470,2000,0,0,0,0,0,formants[1].er,formants[2].er},
	},
	ey= 
	{
		{270,0,2000,0,0,0,0,formants[1].ey,formants[1].ey},
		{1200,2000,1000,0,0,0,0,formants[1].ey,formants[2].ey},
		--{500,1000,1000,0,0,0,0,formants[2].ey,formants[2].ey},
	},	
	ih=
	{
		{280,0,2000,0,0,0,0,formants[1].ih,formants[2].ih},
		{470,2000,0,0,0,0,0,formants[1].ih,formants[2].ih},
	},
	iy=
	{
		{280,0,2000,0,0,0,0,formants[1].iy,formants[1].iy},
		{470,2000,0,0,0,0,0,formants[1].iy,formants[2].iy},
	},
	ow=
	{
		{280,0,2000,0,0,0,0,formants[1].ow,formants[1].ow},
		{800,2000,2000,0,0,0,0,formants[1].ow,formants[2].ow},
		{280,2000,750,0,0,0,0,formants[2].ow,formants[2].ow},

	},
	oy=
	{
		{450,0,2000,0,0,0,0,formants[1].oy,formants[1].oy},
		{1000,2000,200,0,0,0,0,formants[1].oy,formants[2].oy},
	},
	uh=
	{
		{280,0,2000,0,0,0,0,formants[1].uh,formants[2].uh},
		{470,2000,0,0,0,0,0,formants[1].uh,formants[2].uh},
	},
	uw=
	{
		{180,0,2000,0,0,0,0,formants[1].uw,formants[1].uw},
		{840,2000,0,0,0,0,0,formants[1].uw,formants[2].uw},
	},

	aar=
	{
		
		{250,1000,2000,0,0,0,0,formants[1].aa,formants[1].aa},
		{800,2000,1500,0,0,0,0,formants[1].aa,formants[1].r},
	},
	aer=
	{
		{280,0,2000,0,0,0,0,formants[1].ae,formants[1].ae},
		{470,2000,0,0,0,0,0,formants[1].ae,formants[1].r},
	},
	ahr=
	{
		{280,0,2000,0,0,0,0,formants[1].ah,formants[1].ah},
		{470,2000,0,0,0,0,0,formants[1].ah,formants[1].r},
	},
	aor=
	{
		{280,0,2000,0,0,0,0,formants[1].ao,formants[2].ao},
		{470,2000,0,0,0,0,0,formants[1].ao,formants[2].r},
	},
	awr=
	{
		{365,1000,2000,0,0,0,0,formants[1].ah,formants[1].ah},
		{1030,2000,1000,0,0,0,0,formants[1].ah,formants[2].aw},
		{300,1000,0,0,0,0,0,formants[2].aw,formants[2].r,
	},
	ayr=
	{
		{150,1000,2000,0,0,0,0,formants[1].ay,formants[1].ay},
		{250,2000,2000,0,0,0,0,formants[1].ay,formants[1].ay},
		{1380,2000,1000,0,0,0,0,formants[1].ay,formants[2].r},
	},
	ehr=
	{
		{320,0,2000,0,0,0,0,formants[1].eh,formants[1].eh},
		{540,2000,0,0,0,0,0,formants[1].eh,formants[1].r},
	},
	eyr= 
	{
		{270,0,2000,0,0,0,0,formants[1].ey,formants[1].ey},
		{1200,2000,1000,0,0,0,0,formants[1].ey,formants[2].ey},
		{500,1000,1000,0,0,0,0,formants[2].ey,formants[2].r},
	},	
	ihr=
	{
		{280,0,2000,0,0,0,0,formants[1].ih,formants[2].ih},
		{470,2000,0,0,0,0,0,formants[2].ih,formants[2].r},
	},
	iyr=
	{
		{280,0,2000,0,0,0,0,formants[1].iy,formants[1].iy},
		{470,2000,0,0,0,0,0,formants[1].iy,formants[2].iy},
		{470,2000,0,0,0,0,0,formants[2].iy,formants[2].r},
	},
	owr=
	{
		{280,0,2000,0,0,0,0,formants[1].ow,formants[1].ow},
		{800,2000,2000,0,0,0,0,formants[1].ow,formants[2].ow},
		{280,2000,750,0,0,0,0,formants[2].ow,formants[2].r},
	...
	oyr=
	{
		{450,0,2000,0,0,0,0,formants[1].oy,formants[1].oy},
		{1000,2000,200,0,0,0,0,formants[1].oy,formants[2].oy},
		{800,2000,200,0,0,0,0,formants[1].oy,formants[2].oy},
		{200,2000,200,0,0,0,0,formants[1].oy,formants[2].oy},
	},
	uh=
	{
		{280,0,2000,0,0,0,0,formants[1].uh,formants[2].uh},
	...
	haa=
	{
		{300,0,0,0,2,0,0,formants[1].aa,formants[1].aa},
		{280,0,2000,0,0,0,0,formants[1].aa,formants[1].aa},
		{470,2000,0,0,0,0,0,formants[1].aa,formants[1].aa},
	},
	hae=
	{
		{300,0,0,0,2,0,0,formants[1].ae,formants[1].ae},
		{280,0,2000,0,0,0,0,formants[1].ae,formants[1].ae},
		{470,2000,0,0,0,0,0,formants[1].ae,formants[1].ae},
	},
	hah=
	{
		{300,0,0,0,2,0,0,formants[1].ah,formants[1].ah},
		{280,0,2000,0,0,0,0,formants[1].ah,formants[1].ah},
		{470,2000,0,0,0,0,0,formants[1].ah,formants[1].ah},
	},
	hao=
	{
		{300,0,0,0,2,0,0,formants[1].ao,formants[1].ao},
		{280,0,2000,0,0,0,0,formants[1].ao,formants[2].ao},
		{470,2000,0,0,0,0,0,formants[1].ao,formants[2].ao},
	},
	haw=
	...
	hay=
	{
		{300,0,0,0,2,0,0,formants[1].ay,formants[1].ay},
		{150,1000,2000,0,0,0,0,formants[1].ay,formants[1].ay},
		{250,2000,2000,0,0,0,0,formants[1].ay,formants[1].ay},
		{1380,2000,1000,0,0,0,0,formants[1].ay,formants[2].ay},
	},
	heh=
	{
		{300,0,0,0,2,0,0,formants[1].eh,formants[1].eh},
		{320,0,2000,0,0,0,0,formants[1].eh,formants[1].eh},
		{540,2000,0,0,0,0,0,formants[1].eh,formants[1].eh},
	},
	her=
	{
		{300,0,0,0,2,0,0,formants[1].er,formants[1].er},
		{280,0,2000,0,0,0,0,formants[1].er,formants[2].er},
		{470,2000,0,0,0,0,0,formants[2].er,formants[2].er},
	},
	hey=  --DEFECTIVE sound envelope and cascade envelope two separate things.
	{
		{300,0,0,0,2,0,0,formants[1].ey,formants[1].ey},
		{270,0,2000,0,0,0,0,formants[1].ey,formants[1].ey},
		{1200,2000,1000,0,0,0,0,formants[1].ey,formants[2].ey},
	...
	hih=
	{
		{300,0,0,0,2,0,0,formants[1].ih,formants[1].ih},
		{280,0,2000,0,0,0,0,formants[1].ih,formants[1].ih},
		{470,2000,0,0,0,0,0,formants[1].ih,formants[2].ih},
	},
	hiy=
	{
		{300,0,0,0,2,0,0,formants[1].iy,formants[1].iy},
		{280,0,2000,0,0,0,0,formants[1].iy,formants[1].iy},
		{470,2000,0,0,0,0,0,formants[2].iy,formants[2].iy},
	},
	how=
	{
		{300,0,0,0,2,0,0,formants[1].ow,formants[1].ow},
		{280,0,2000,0,0,0,0,formants[1].ow,formants[1].ow},
		{800,2000,2000,0,0,0,0,formants[1].ow,formants[2].ow},
		{280,2000,750,0,0,0,0,formants[2].ow,formants[2].ow},
	...
	hoy=
	{
		{300,0,0,0,2,0,0,formants[1].oy,formants[1].oy},
		{450,0,2000,0,0,0,0,formants[1].oy,formants[1].oy},
		{1000,2000,200,0,0,0,0,formants[1].oy,formants[2].oy},
	},
	huh=
	{
		{300,0,0,0,2,0,0,formants[1].uh,formants[1].uh},
		{280,0,2000,0,0,0,0,formants[1].uh,formants[1].uh},
		{470,2000,0,0,0,0,0,formants[1].uh,formants[2].uh},
	},
	huw=
	{
		{300,0,0,0,2,0,0,formants[1].uw,formants[1].uw},
		{180,0,2000,0,0,0,0,formants[1].uw,formants[1].uw},
		{840,2000,0,0,0,0,0,formants[1].uw,formants[2].uw},
	},
...
function phonate(speech)
	...
	for phoneme in all (split(speech)) do
		...
		for i=1,#p do
			...
			voicing_duration+=d
			local c1=f[8] --from formants
			local c2=f[9] --to formants
			for j=1,3 do
				add(c,{unpack(c1[j])})
				c[j].y0=0
				c[j].y1=0
				...
				c[j][3]=c2[j][1]
				c[j][4]=c2[j][2]
				add(f_glide,(c[j][3]-c[j][1])/d)
				add(bw_glide,(c[j][4]-c[j][2])/d)
			end

...
data=split("aa=1320,1,500,4,3,0,1,2600,160,1220,70,700,130,-250,100;ae=1270,1,1000,1,2,0,.79,2430,320,1660,150,620,170,-250,100;ah=660,1,1000,4,3,0,.79,2550,140,1220,50,620,80,-250,100;ao=1320,1,1000,4,3,0,.74,2570,80,990,100,600,90,-250,100;aw=720,1,1000,4,3,0,.79,2550,140,1220,50,620,80,-250,100/720,1,1000,4,0,0,0,2960,400,2020,100,310,70,-250,100;ay=690,1,1000,4,3,0,.9,2550,200,1200,70,660,100,-250,100/690,1,1000,4,2,0,.223,2550,200,1880,100,400,70,-250,100;eh=830,1,1000,4,3,0,.44,2520,200,1720,100,480,70,-250,100;er=1480,1,1000,4,2,0,.41,1540,110,1270,60,470,100,-250,100;ey=520,1,500,4,3,0,.44,2520,200,1720,100,480,70,-250,100/520,1,500,4,0,0,.05,2600,200,2020,100,330,50,-250,100;ih=720,1,1000,4,3,0,.23,2570,140,1800,100,400,50,-250,100;iy=880,1,1000,4,3,0,0,2960,400,2020,100,310,70,-250,100;ow=1210,1,1000,4,3,0,.59,2300,70,1100,70,540,80,-250,100;oy=513,1,1000,3,3,0,.62,2400,130,960,50,550,60,-250,100/513,1,1000,0,1,0,.13,2400,130,1820,50,360,80,-250,100/513,1,1000,0,1,0,.13,2400,130,1820,50,360,80,-250,100;uh=880,1,1000,4,3,0,.36,2350,80,1100,100,450,80,-250,100;uw=390,1,1000,3,3,0,.1,2200,140,1250,110,350,70,-250,100/390,1,1000,0,1,0,-.12,2200,140,900,110,320,70,-250,100/390,1,1000,0,0,0,-.12,2200,140,900,110,320,70,-250,100;l=440,1,1000,4,3,0,0,2880,280,1050,100,310,50,-250,100;r=440,1,1000,2,3,0,0,1380,120,1060,100,310,70,-250,100;m=390,1,1000,0,0,0,0,2150,200,1100,150,400,300,-450,100;n=360,1,1000,0,0,0,0,2600,170,1600,100,200,60,-450,100;ng=440,1,1000,0,0,0,0,2850,280,1990,150,200,60,-450,100;ch=230,0,200,3,0,1,0,2820,300,1800,90,350,200,-250,100/100,0,100,1,0,1,0,2820,300,1800,90,350,200,-250,100;jh=1,1,1000,0,0,1,0,2820,270,1800,80,260,60,-250,100/330,1,500,1,0,1,0,2820,270,1800,80,260,60,-250,100;dh=275,1,250,0,0,.5,0,2540,170,1290,80,270,60,-250,100;f=1,0,15,0,0,1,0,2080,150,1100,120,340,200,-250,100/660,0,25,1,0,1,0,2080,150,1100,120,340,200,-250,100;s=1,0,20,0,0,1,0,2530,200,1390,80,320,200,-250,100/690,0,40,1,0,1,0,2530,200,1390,80,320,200,-250,100;sh=1,0,40,0,0,1,0,2750,300,1840,100,300,200,-250,100/690,0,40,3,0,1,0,2750,300,1840,100,300,200,-250,100;zh=1,1,250,0,0,.5,0,2750,300,1840,100,300,200,-250,100/385,1,400,1,0,.5,0,2750,300,1840,100,300,200,-250,100;k=50,0,100,0,0,1,0,2850,330,1900,160,300,250,-250,100/250,0,5,1,0,1,0,2850,330,1900,160,300,250,-250,100;p=50,0,50,0,0,1,0,2150,220,1100,150,400,300,-250,100/225,0,2,1,0,1,0,2150,220,1100,150,400,300,-250,100;t=50,0,100,0,0,2,0,2600,250,1600,120,400,300,-250,100/270,0,5,0,0,1,0,2600,250,1600,120,400,300,-250,100;g=90,1,1000,0,0,1,0,2850,280,1990,150,200,60,-250,100;b=440,1,100,0,1,0,0,2150,220,1100,150,400,300,-250,100/70,1,1000,0,0,1,0,2150,220,1100,150,400,300,-250,100;d=70,1,1000,0,0,1,0,2600,170,1600,100,200,60,-250,100;th=606,0,10,0,0,1,0,2540,200,1290,90,320,200,-250,100;v=330,1,1000,0,0,.5,0,2080,120,1100,90,220,60,-250,100;z=410,1,1000,0,1,.5,0,2530,180,1390,60,240,70,-250,100;w=440,1,260,4,4,0,.1,2150,60,610,80,290,50,-250,100;y=440,1,1000,0,3,0,0,3020,500,2070,250,260,40,-250,100;",";")
phone={}
	...
	function say(speech)
		...
		for i,phoneme in pairs(phonemes) do
			...
			if stress then
				...
				if (stress_type==3) p_stress=spk8_f0*sign*magnitude
...
function speako8()
	function set_voice()
		w0=((5512.5/(spk8_f0+spk8_vibrato*sin(time()*5.5)+p_stress))+(w0 and w0*99 or 0))/(w0 and 100 or 1)
	end
	if #sounds >0 then
				...
				if current_sound then
					...
					if source then  --if not silence
						...
						for k,resonator in pairs(cascade) do
							local f,bw,a0,b0,c0=resonator[1]/spk8_tract,resonator[2]\10+1
...
function _init()
	...
	spk8_vibrato=1-- in hz how much variation in wavelength
	--spk8_tremolo=0
	spk8_intonation=10--20 hz for women, 10 for men, 0 for robotic monotone
	spk8_rate=1.1 --duration multiplier for voiced sounds. <below 1 faster, above 1 slower
	spk8_tract=1  --vocal tract higher for men 1 is average, lower for women .85 average for women, children
...
--say'-/-1.28/dh/-1.50/ah/-1.33/ow/-1.28/l/-1.74/_/d/-1.2/m/-1.36/ae/-1.26/n/-1.9/s/-1.36/ae/-1.74/_/t/-1.54/ih/-1.50/n/-1.28/dh/-1.50/ah/-1.19/r/-1.39/aa/-1.80/_/k/-1.35/er'

--say'_/-1.15/f/-1.25/r/-1.35/eh/-1.11/n/-1.73/_/d/-1.24/z/_/-1.36/r/-1.48/ow/-1.2/m/-1.63/ah/-1.13/n/-1.24/z/_/-1.70/_/k/-1.13/ah/-1.21/n/-1.74/_/t/-1.25/r/-1.67/iy/-1.2/m/-1.67/ih/-1.14/n/_/-1.20/l/-1.31/eh/-1.11/n/-1.72/_/d/-1.4/m/-1.25/iy/y/-1.26/ao/-1.9/r/1.28/ih/1.23/r/-1.6/z/_/-1.10/ay/-1.67/_/k/-1.2/ah/-1.2/m/-1.71/_/t/-1.14/uw/-1.60/_/b/-1.35/eh/-1.9/r/-1.56/iy/s/-1.35/iy/-1.6/z/-1.62/er/_/-1.18/n/-1.37/aa/-1.69/_/t/-1.71/_/t/-1.14/uw/-1.62/_/p/-1.25/r/-1.18/ey/-1.6/z/-1.30/hh/1.28/ih/-1.2/m'
--say'_/-1.15/f/-1.25/r/-1.35/eh/-1.11/n/-1.73/_/d/-1.24/z/_/-1.36/r/-1.48/ow/-1.2/m/-1.63/ah/-1.13/n/-1.24/z/_/-1.70/_/k/-1.13/ah/-1.21/n/-1.74/_/t/-1.25/r/-1.67/iy/1.2/m/-1.67/ih/1.14/n/_/-1.20/l/-1.31/eh/-1.11/n/-1.72/_/d/-1.4/m/-1.25/iy/y/-1.26/ao/-1.9/r/1.28/ih/1.57/r/1.9/z/_/-1.10/ay/-1.67/_/k/-1.2/ah/-1.2/m/-1.71/_/t/-1.14/uw/-1.60/_/b/-1.35/eh/-1.9/r/-1.56/iy/s/-1.35/iy/-1.6/z/-1.62/er/_/-1.18/n/-1.37/aa/-1.69/_/t/-1.71/_/t/-1.14/uw/-1.62/_/p/-1.25/r/-1.18/ey/1.1/z/-1.30/hh/1.28/ih/1.3/m/_/'

say'_/-1.15/f/-1.25/r/-1.35/3.15/eh/-1.11/n/-1.73/_/d/-1.24/z/_/-1.36/r/-1.48/3.15/ow/-1.2/m/-1.63/ah/-1.13/n/-1.24/z/_/-1.70/_/k/-1.13/3.15/ah/-1.21/n/-1.74/_/t/-1.25/r/-1.67/iy/-1.2/m/-1.67/ih/-1.14/n/_/-1.20/l/-1.31/3.15/eh/-1.11/n/-1.72/_/d/-1.4/m/-1.25/iy/y/-1.26/ao/-1.9/r/1.28/3.15/ih/1.57/r/1.9/z/_/-1.10/ay/-1.67/_/k/-1.2/3.15/ah/-1.2/m/-1.71/_/t/-1.14/uw/-1.60/_/b/-1.35/3.15/eh/-1.9/r/-1.56/iy/s/-1.35/3.15/iy/-1.6/z/-1.62/er/_/-1.18/n/-1.37/3.15/aa/-1.69/_/t/-1.71/_/t/-1.14/uw/-1.62/_/p/-1.25/r/-1.18/3.15/ey/1.1/z/-1.30/hh/1.28/ih/1.3/m'
--say'm/_/'

...
--	phone["_"]={{1100,1,0,4,0,0,0,nil}}
	...
	--TO DO: hyphen voice previous sound toward100 volume for 100 miliseconds. if next sound is voiced set volume to 100 using next sounds data.
...
say"-1.40/ay/-1.40/ae/m/s/p/-1.40/iy/k/-1.40/ow/1.40/ey/t"
	end	
end
function _draw()
cls()

...
volume=1
aspiration=1
duration,v,v_step,v_max,cascade,f_step,bw_step,stress,c2=0,{},{},{},{},{},{},{},{}
...
phone=
{
	AA=
	{
		...
		{
			{76,{500,0,0,{{2600,160},{1220,70},{700,130},{-250,100}}},nil}
		},
		{
			{380,{1000,4,2,{{2600,160},{1220,70},{700,130},{-250,100}}},nil}
		},
		{
			{127,{500,4,0,{{2600,160},{1220,70},{700,130},{-250,100}}},nil}
		},
	...
	AE=
	{
		...
		{
			{76,{1000,0,0,{{2430,320},{1660,150},{620,170},{-250,100}}},nil},
		},
		{
			{380,{1000,4,2,{{2430,320},{1660,150},{620,170},{-250,100}}},nil}
		},
		{
			{127,{1000,4,0,{{2430,320},{1660,150},{620,170},{-250,100}}},nil}
		},
	...
	{
		{
			{136,{1000,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}},nil}
		},
		{
			{380,{1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},nil},
		},	
		{
			{227,{1000,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}},nil}
		},
	...
	{
		{
			{76,{1000,0,0,{{2570,80},{990,100},{600,90},{-250,100}}},nil}
		},
		{
			{380,{1000,4,2,{{2570,80},{990,100},{600,90},{-250,100}}},nil},
		},	
		{
			{127,{1000,4,0,{{2570,80},{990,100},{600,90},{-250,100}}},nil}
		}
	},
	AW= 
	{
		{
			{70,{1000,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}},nil}
		},
		{
			{350,{1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},nil},
			{350,{1000,4,0,{{2350,80},{900,70},{450,80},{-250,100}}},nil},
		},	
		{
			{117,{1000,4,0,{{2350,80},{900,70},{450,80},{-250,100}}},nil}
		},
	},
	AY=
	{
		{
			{70,{1000,0,0,{{2550,200},{1200,70},{660,100},{-250,100}}},nil},
		},	
		{
			{350,{1000,4,2,{{2550,200},{1200,70},{660,100},{-250,100}}},nil},
			{350,{1000,4,0,{{2550,200},{1880,100},{400,70},{-250,100}}},nil},
		},	
		{	
			{117,{1000,4,0,{{2550,200},{1880,100},{400,70},{-250,100}}},nil},
		}	
	},
	EH=
	{
		{
			{76,{1000,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},nil},
		},
		{
			{380,{1000,4,2,{{2520,200},{1720,100},{480,70},{-250,100}}},nil},
		},
		{
			{127,{1000,4,0,{{2520,200},{1720,100},{480,70},{-250,100}}},nil},
		}	
	},
	ER=
	{
		{
			{62,{1000,0,0,{{1540,110},{1270,60},{470,100},{-250,100}}},nil},
		},	
		{
			{310,{1000,4,2,{{1540,110},{1270,60},{470,100},{-250,100}}},nil},
			{320,{1000,4,0,{{1540,110},{1310,60},{420,100},{-250,100}}},nil},
		},	
		{
			{107,{1000,4,0,{{1540,110},{1310,60},{420,100},{-250,100}}},nil},
		}
	},
	EY= 
	{
		{
			{64,{1000,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},nil},
		},	
		{
			{320,{1000,4,2,{{2520,200},{1720,100},{480,70},{-250,100}}},nil},
			{320,{1000,4,0,{{2600,200},{2020,100},{330,50},{-250,100}}},nil},
		},	
		{
			{107,{1000,4,0,{{2600,200},{2020,100},{330,50},{-250,100}}},nil},
		}	
	},	
	...
	{
		{
			{40,{1000,0,0,{{2570,140},{1800,100},{400,50},{-250,100}}},nil},
		},	
		{
			{400,{1000,4,2,{{2570,140},{1800,100},{400,50},{-250,100}}},nil},
		},	
		{	
			{67,{1000,4,0,0,{{2570,140},{1600,100},{470,50},{-250,100}}},nil},
		}
	},
	IY= 
	{
		{
			{56,{1000,0,0,{{2960,400},{2020,100},{310,70},{-250,100}}},nil},
		},	
		{
			{560,{1000,4,2,{{2960,400},{2020,100},{310,70},{-250,100}}},nil},
			
		},	
		{
			{93,{1000,4,1,{{2960,400},{2070,100},{290,50},{-250,100}}},nil},
		}	
	},
	OW= 
	{
		{
			{64,{1000,0,0,{{2300,70},{1100,70},{540,80},{-250,100}}},nil},
		},	
		{
			{320,{1000,4,2,{{2300,70},{1100,70},{540,80},{-250,100}}},nil},
			{320,{1000,4,0,{{2300,70},{900,70},{450,80},{-250,100}}},nil},
		},	
		{
			{107,{1000,4,0,{{2300,70},{900,70},{450,80},{-250,100}}},nil},
		}
	},
	OY=
	{
		{
			{70,{1000,0,0,{{2400,130},{960,50},{550,60},{-250,100}}},nil},
		},	
		{
			{350,{1000,4,2,{{2400,130},{960,50},{550,60},{-250,100}}},nil},
			{350,{1000,4,0,{{2400,130},{1820,50},{360,80},{-250,100}}},nil},
		},
		{
			{117,{1000,4,0,{{2400,130},{1820,50},{360,80},{-250,100}}},nil},
		}	
	},
	UH=
	{
		{
			{40,{1000,0,0,{{2350,80},{1100,100},{450,80},{-250,100}}},nil}
		},
		{
			{200,{1000,4,2,{{2350,80},{1100,100},{450,80},{-250,100}}},nil},
			{200,{1000,4,0,{{2350,80},{1180,100},{500,80},{-250,100}}},nil},
		},	
		{
			{67,{1000,4,0,{{2350,80},{1180,100},{500,80},{-250,100}}},nil},
		}	
	},
	UW=
	{
		...
		{
			{54,{1000,0,0,{{2200,140},{1250,110},{350,70},{-250,100}}},nil},
		},	
		{
			{270,{1000,4,2,{{2200,140},{1250,110},{350,70},{-250,100}}},nil},
			{270,{1000,4,0,{{2200,140},{900,110},{320,70},{-250,100}}},nil},
		},	
		{
			{90,{1000,4,0,{{2200,140},{900,110},{320,70},{-250,100}}},nil},
		}	
	...
	{
		{
			{100,{1000,0,0,{{2880,280},{1050,100},{310,50},{-250,100}}},nil}
		},
		{
			{300,{1000,4,2.4,{{2880,280},{1050,100},{310,50},{-250,100}}},nil}
		},
		{
			{500,{500,4,0,{{2880,280},{1050,100},{310,50},{-250,100}}},nil}
		},
	},
	LL=
	{
		{
			{1,{1000,0,0,{{2880,280},{1050,100},{310,50},{-250,100}}},nil},
		},	
		{
			{100,{1000,4,2,{{2880,280},{1050,100},{310,50},{-250,100}}},nil},
			{200,{750,4,0,{{2880,280},{850,100},{470,50},{-250,100}}},nil},
		},	
		{
			{200,{350,4,0,{{2880,280},{850,100},{470,50},{-250,100}}},nil},
			{100,{350,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}},nil},
		},
	...
	{
		{
			{130,{1000,0,0,{{2150,200},{1100,150},{400,300},{-450,100}}},nil},
		},	
		{
			{250,{1000,4,2.4,{{2150,200},{1100,150},{400,300},{-450,100}}},nil},
		},	
		{
			{130,{1000,4,0,{{2150,200},{1100,150},{400,300},{-450,100}}},nil},
			{100,{1000,4,0,{{2550,140},{1800,50},{620,80},{-250,0}}},nil},
		},
	},
	...
	{
		{
			{140,{1000,0,0,{{2600,170},{1600,100},{200,60},{-450,100}}},nil},
		},	
		{
			{230,{1000,4,2.4,{{2600,170},{1600,100},{200,60},{-450,100}}},nil},
	...
	{
		{
			{140,{1000,0,0,{{2850,280},{1990,150},{200,60},{-450,0}}},nil}
		},
		{
			{380,{1000,4,2.4,{{2850,280},{1990,150},{200,60},{-450,0}}},nil},
		},	
		{
			{140,{1000,4,0,{{2850,280},{1990,150},{200,60},{-450,0}}},nil},
			{100,{1000,4,0,{{2550,140},{1800,50},{620,80},{-250,0}}},nil},
		},
	},
	R=
	{
		{
			{200,{1000,0,0,{{1380,120},{1060,100},{310,70},{-250,100}}},nil},
		},
		{
			{390,{1000,4,2,{{1380,120},{1060,100},{310,70},{-250,100}}},nil},
		},	
		{
			{200,{800,4,0,{{1380,120},{1060,100},{310,70},{-250,100}}},nil},
		}	
	},
	SCHWA=
	{
		{
			{10,{1000,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}},nil},
		},	
		{
			{270,{1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},nil},
		},
		{
			{10,{1000,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}},nil},
		}	
	},
	...
	S=
	{
		...
		{
			{30,nil,{.2,0,0,{{2550,300}}}},
		},
		{
			{400,nil,{.2,0,0,{{2550,300}}}},
	...
	{
		{
			{10,nil,{.06,0,0,{{2400,60},{2000,400}}}},
		},
		{
			{20,nil,{.06,0,0,{{2400,60},{2000,400}}}},
			{460,nil,{.2,1,0,{{2400,60},{2000,400}}}},
		},
		{
			{30,nil,{.2,0,0,{{2400,60},{2000,400}}}},
		},
	},
	SH=
	{
		...
		},
		{
			{20,nil,{.06,0,0,{{2400,60},{2000,400}}}},
			{460,nil,{.2,1,0,{{2400,60},{2000,400}}}},
			{270,{200,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},nil}
		},
		{
			{30,nil,{.2,0,0,{{2400,60},{2000,400}}}},
		},
	...
	{
		{
			{30,nil,{.002,0,0,{{2550,300}}}},
		},
		{
			{400,nil,{.002,0,0,{{2550,300}}}}
		},
		{
			{30,nil,{.002,0,0,{{2550,300}}}},
		},
	...
	{
		{
			{30,{200,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},{.002,0,0,{{2400,60},{2000,400}}}},
		},
		{
			{400,{200,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},{.002,0,0,{{2400,60},{2000,400}}}}
		},
		{
			{30,{200,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},{.002,0,0,{{2400,60},{2000,400}}}},
		},
	...
	TH=
	{
		...
		{
			{400,nil,{.002,0,0,{{2400,60},{2000,400}}}}
		},
		{
			{30,nil,{.002,0,0,{{2400,60},{2000,400}}}},
		},
	...
	{
		{
			{590,{70,0,0,{{2150,60},{610,80},{290,50},{-250,100}}},nil}
		},
		{
			{215,{260,2,2,{{2150,60},{610,80},{290,50},{-250,100}}},nil}
		},
		{
			{30,{260,0,0,{{2150,60},{610,80},{290,50},{-250,100}}},nil},
		}	
	},
	...
	{
		{
			{200,{1000,0,0,{{3020,500},{2070,250},{260,40},{-250,100}}},nil},
		},
		{
			{400,{1000,0,2,{{3020,500},{2070,250},{260,40},{-250,100}}},nil},
		},	
		{
			{200,{1000,0,0,{{3020,500},{2070,250},{260,40},{-250,100}}},nil},
		}	
...
local a100,a200=1-b100-c100,1-b200-c200
	...
	function phonate(speech)
		...
		function prepare(attack,d,c1,v1,stress,volume,velocity,blend,cascade)
		...
		--[[	if attack then
			...
			--{76,nil,{500,0,0,{{2600,160},{1220,70},{700,130},{-250,100}}}}
			return {v1,velocity*(v2-v1)/d,v2,c,f_glide,bw_glide,stress,c2},c2,v2
		end	
				...
				for i=0,127 do
					...
					if current_sound then
						if duration <= 0 and current_sound then
							...
							for track =1,2 do
								v[track],v_step[track],v_max[track],cascade[track],f_step[track],bw_step[track],stress[track],c2[track]=unpack(current_sound[1+track] or {0,0,0,{},{},{},1,{}})
							end
...
phonate"SH IY1 . S EH1 L Z . S IY1 SH EH2 L Z . AA1 N . DH AH0 . S IY1 SH AO2 R ."

...
--todd tat cut caught cow tide ted curt tate kit teat coat toy could two
do
	phone=
	{
		AA=
		{
			...
			{
				{100,1,500,0,0,0,{{2600,160},{1220,70},{700,130},{-250,100}}}
			},
			{
				{660,1,500,4,3,0,{{2600,160},{1220,70},{700,130},{-250,100}}}
			},
			{
				{100,1,500,4,0,0,{{2600,160},{1220,70},{700,130},{-250,100}}}
			},
		...
		AE=
		{
			...
			{
				{100,1,500,0,0,0,{{2430,320},{1660,150},{620,170},{-250,100}}},
			},
			{
				{700,1,1000,4,3,0,{{2430,320},{1660,150},{620,170},{-250,100}}}
			},
			{
				{100,1,500,4,0,0,{{2430,320},{1660,150},{620,170},{-250,100}}}
			},
		...
		{
			{
				{100,1,500,0,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}}
			},
			{
				{610,1,1000,4,3,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
			},	
			{
				{100,1,500,4,3,0,{{2550,140},{1220,50},{620,80},{-250,100}}}
			},
		...
		{
			{
				{100,1,500,0,0,0,{{2570,80},{990,100},{600,90},{-250,100}}}
			},
			{
				{810,1,1000,4,3,0,{{2570,80},{990,100},{600,90},{-250,100}}},
			},	
			{
				{100,1,500,4,0,0,{{2570,80},{990,100},{600,90},{-250,100}}}
			}
		},
		AW= 
		{
			...
			{
				{330,1,1000,4,3,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
				{330,1,1000,4,0,0,{{2960,400},{2020,100},{310,70},{-250,100}}},
			},	
			{
				{100,1,500,4,0,0,{{2350,80},{900,70},{450,80},{-250,100}}}
			},
		},
		AY=
		{
			{
				{100,1,500,0,0,0,{{2550,200},{1200,70},{660,100},{-250,100}}},
			},	
			{
				{370,1,1000,4,3,0,{{2550,200},{1200,70},{660,100},{-250,100}}},
				{370,1,1000,4,2,0,{{2550,200},{1880,100},{400,70},{-250,100}}},
			},	
			{	
				{100,1,500,4,0,0,{{2550,200},{1880,100},{400,70},{-250,100}}},
			}	
		},
		EH=
		{
			{
				{100,1,500,0,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},
			},
			{
				{410,1,1000,4,3,0,{{2520,200},{1720,100},{480,70},{-250,100}}},
			},
			{
				{100,1,500,1,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},
			}	
		},
		ER=
		{
			{
				{100,1,500,0,0,0,{{1540,110},{1270,60},{470,100},{-250,100}}},
			},	
			{
				{370,1,1000,4,3,0,{{1540,110},{1270,60},{470,100},{-250,100}}},
				{370,1,1000,4,0,0,{{1540,110},{1310,60},{420,100},{-250,100}}},
			},	
			{
				{100,1,500,4,0,0,{{1540,110},{1310,60},{420,100},{-250,100}}},
			}
		},
		EY= 
		{
			{
				{100,1,250,0,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},
			},	
			{
				{370,1,500,4,3,0,{{2520,200},{1720,100},{480,70},{-250,100}}},
				{370,1,500,4,0,0,{{2600,200},{2020,100},{330,50},{-250,100}}},
			},	
			{
				{100,1,250,4,0,0,{{2600,200},{2020,100},{330,50},{-250,100}}},
			}	
		},	
		...
		{
			{
				{100,1,500,0,0,0,{{2570,140},{1800,100},{400,50},{-250,100}}},
			},	
			{
				{580,1,1000,4,3,0,{{2570,140},{1800,100},{400,50},{-250,100}}},
			},	
			{	
				{100,1,500,4,0,0,{{2570,140},{1600,100},{470,50},{-250,100}}},
			}
		},
		IY= 
		{
			{
				{100,1,500,0,0,0,{{2960,400},{2020,100},{310,70},{-250,100}}},
			},	
			{
				{650,1,1000,4,3,0,{{2960,400},{2020,100},{310,70},{-250,100}}},
				
			},	
			{
				{100,1,500,4,1,0,{{2960,400},{2070,100},{290,50},{-250,100}}},
			}	
		},
		OW= 
		{
			{
				{100,1,500,0,0,0,{{2300,70},{1100,70},{540,80},{-250,100}}},
			},	
			{
				{390,1,1000,4,3,0,{{2300,70},{1100,70},{540,80},{-250,100}}},
				{390,1,1000,4,0,0,{{2300,70},{900,70},{450,80},{-250,100}}},
			},	
			{
				{100,1,500,4,0,0,{{2300,70},{900,70},{450,80},{-250,100}}},
			}
		},
		OY=
		{
			{
				{100,1,500,0,0,0,{{2400,130},{960,50},{550,60},{-250,100}}},
			},	
			{
				{520,1,1000,4,3,0,{{2400,130},{960,50},{550,60},{-250,100}}},
				{520,1,1000,4,2,0,{{2400,130},{1820,50},{360,80},{-250,100}}},
			},
			{
				{100,1,500,4,0,0,{{2400,130},{1820,50},{360,80},{-250,100}}},
			}	
		},
		UH=
		{
			{
				{100,1,500,0,0,0,{{2350,80},{1100,100},{450,80},{-250,100}}}
			},
			{
				{80,1,1000,4,3,0,{{2350,80},{1100,100},{450,80},{-250,100}}},
				{80,1,1000,4,0,0,{{2350,80},{1180,100},{500,80},{-250,100}}},
			},	
			{
				{100,1,500,4,0,0,{{2350,80},{1180,100},{500,80},{-250,100}}},
			}	
		}, 
		UW=
		{
			...
			{
				{100,1,500,0,0,0,{{2200,140},{1250,110},{350,70},{-250,100}}},
			},	
			{
				{540,1,1000,4,3,0,{{2200,140},{1250,110},{350,70},{-250,100}}},
				{540,1,1000,4,0,0,{{2200,140},{900,110},{320,70},{-250,100}}},
			},	
			{
				{100,1,500,4,0,0,{{2200,140},{900,110},{320,70},{-250,100}}},
			}	
		...
		L=
		{
			...
			{
				{500,1,750,4,3,0,{{2880,280},{1050,100},{310,50},{-250,100}}}
			},
			{
...
--				{50,1,250,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
		...
		M=
		{
			...
			{
				{310,1,350,4,3,0,{{2150,200},{1100,150},{400,300},{-450,100}}},
...
--				{50,1,250,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
	...
	--{450,{0,3,0,0,{{2530,200},{1390,80},{320,200},{-250,100}}},1},
		N=
		{
			...
			{
				{230,1,350,4,3,1,{{2600,170},{1600,100},{200,60},{-450,100}}},
				
		
			},	
			{
				{140,1,350,0,0,0,{{2600,170},{1600,100},{200,60},{-450,100}}},
				{50,1,250,1,1,0,{{2600,170},{1600,100},{200,60},{-250,100}}},
			},
		},
		NG=
		{
			...
			{
				{380,1,500,4,3,0,{{2850,280},{1990,150},{200,60},{-450,0}}},
			},	
			{
				{140,1,500,0,0,0,{{2850,280},{1990,150},{200,60},{-450,0}}},
...
--				{50,1,250,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
		...
		R=
		{
			...
			{
				{300,1,1000,2,3,0,{{1380,120},{1060,100},{310,70},{-250,100}}},
			},	
			{
...
--				{50,1,250,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
		...
		CH=
		{
			...
			{
				{200,0,0,0,0,1,{{2820,300},{1800,90},{350,200},{-250,100}}},
				{230,0,200,3,0,1,{{2820,300},{1800,90},{350,200},{-250,100}}},
				{100,0,100,1,0,1,{{2820,300},{1800,90},{350,200},{-250,100}}},
				{1,0,0,0,0,1,{}}, --{} prevents blending
			},
			{
				{1,2,0,0,0,0,{{2820,300},{1800,90},{350,200},}},
				{100,2,1,0,0,0,{{2820,300},{1800,90},{350,200},}},
			},
		},
		...
		JH=
		{
			...
			{
				{200,0,0,0,0,1,{{2820,270},{1800,80},{260,60},{-250,100}}},
				{50,0,250,0,0,1,{{2820,270},{1800,80},{260,60},{-250,100}}},
				{230,1,1000,4,0,1,{{2820,270},{1800,80},{260,60},{-250,100}}},
			},
			{
				{100,1,500,2,0,0,{{2820,270},{1800,80},{260,60},{-250,100}}},
				{50,2,1,0,0,0,{{2820,270},{1800,80},{260,60},{-250,100}}},
			},
		},
		...
		DH=
		{
			...
			{
				{530,1,250,0,0,.5,{{2540,170},{1290,80},{270,60},{-250,100}}},
			},
			{
			},
		},
		...
		S=
		{
			...
			{
			--	{1,0,20,0,0,.5,{{2530,200},{1390,80},{320,200},{-250,100}}},
			},
			{
			...
			{
				{400,0,10,1,0,1,{{2530,200},{1390,80},{320,200},{-250,100}}},
				{50,2,1,0,0,0,{{2530,200},{1390,80},{320,200},{-250,100}}},
		...
		SH=
		{
			...
			{
				{1,0,40,0,0,1,{{2750,300},{1840,100},{300,200},{-250,100}}},
				{400,0,40,3,0,1,{{2750,300},{1840,100},{300,200},{-250,100}}},
				{150,0,30,1,0,1,{{2750,300},{1840,100},{300,200},{-250,100}}},
			--	{1,0,0,0,0,1,{}}, --{} prevents blending
			},
			{
		...
		ZH=
		{
			...
			{
				{1,1,250,0,0,.5,{{2750,300},{1840,100},{300,200},{-250,100}}},
				{500,1,400,1,0,.5,{{2750,300},{1840,100},{300,200},{-250,100}}},
				
			},
			{
				{250,1,0,1,0,.5,{{2750,300},{1840,100},{300,200},{-250,100}}},
			},
		},
		...
		K=
		{
			...
			},
			{
				...
				{230,0,60,10,0,1,{{2850,330},{1900,160},{300,250},{-250,100}}},
				--{50,2,1,1,0,0,{{2850,330},{1900,160},{300,250},{-250,100}}},
				--{1,0,0,0,0,1,{}}, --{} prevents blending

			},
			{
				{1,2,2,0,0,0,{{2850,330},{1900,160},{300,250},{-250,100}}},
				{50,2,0,1,0,0,{{2850,330},{1900,160},{300,250},{-250,100}}},
			--	{50,1,0,0,0,0,{{2850,330},{1900,160},{300,250},{-250,100}}},
		...
		P=
		{
			...
			},
			{
				...
				{180,0,60,0,0,1,{{2150,220},{1100,150},{400,300},{-250,100}}},
			--	{1,0,0,0,0,1,{}}
			},
			{
				{1,2,2,0,0,0,{{2150,220},{1100,150},{400,300},{-250,100}}},
				{50,2,0,1,0,0,{{2150,220},{1100,150},{400,300},{-250,100}}},
			},
		},
		T=
		{
			...
			},
			{
				...
				{230,0,20,5,0,1,{{2600,250},{1600,120},{400,300},{-250,100}}},
			--	{100,2,1.5,1,0,0,{{2600,250},{1600,120},{400,300},{-250,100}}},
			{1,0,0,0,0,1,{}}, --{} prevents blending

			},
			{
				--{50,1,250,1,1,0,{{2600,250},{1600,120},{400,300},{-250,100}}},
			},
		},
		G=
		{
			...
			},
			{
				...
				{230,1,1000,10,0,.5,{{2850,280},{1900,150},{200,60},{-250,100}}},
			},
			{
				{100,1,500,1,0,.1,{{2850,280},{1900,150},{200,60},{-250,100}}},
			},
		},
		...
		B=
		{
			...
			{
				{1,1,0,0,0,0,{{2150,130},{1100,110},{200,60},{-250,100}}},
				{230,1,1000,10,0,.5,{{2150,130},{1100,110},{200,60},{-250,100}}},
				--{100,2,1,0,0,0,{{2150,220},{1100,150},{400,300},{-250,100}}},

			},
			{
				{100,1,250,1,0,0,{{2150,220},{1100,150},{400,300},{-250,100}}}
			},
		},
		D=
		{
			...
			},
			{
				...
				{230,1,1000,10,0,.5,{{2600,170},{1600,100},{200,60},{-250,100}}},
				--{100,2,1.5,0,0,0,{{2600,250},{1600,120},{200,300},{-250,100}}},

			},
			{
				{100,1,250,1,0,0,{{2600,170},{1600,100},{200,60},{-250,100}}}
			},
		},
		...
		TH=
		{
			...
			},
			{
				...
				{200,0,0,0,0,1,{{2540,200},{1290,90},{320,200},{-250,100}}}
		...
		V=
		{
			...
			{1,1,0,0,0,0,{{2080,120},{1100,90},{220,60},{-250,100}}},
				{450,1,1000,5,0,.5,{{2080,120},{1100,90},{220,60},{-250,100}}},
			},
			{
				{50,1,250,1,1,0,{{2080,120},{1100,90},{220,60},{-250,100}}},
			},
		},
		Z=
		{
			...
			{
				--{100,1,500,0,0,1,{{2530,180},{1390,60},{240,70},{-250,100}}},
				{500,1,1000,0,1,.5,{{2530,180},{1390,60},{240,70},{-250,100}}},
				
			},
			{
				{200,1,250,1,0,.5,{{2530,180},{1390,60},{240,70},{-250,100}}},
				--{300,1,250,1,0,.5,{{2530,180},{1390,60},{240,70},{-250,100}}},
				--{100,1,1,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
			},
		},
		...
		{
			{
				{400,1,70,0,0,0,{{2150,60},{610,80},{290,50},{-250,100}}}
			},
			{
				{400,1,260,4,4,0,{{2150,60},{610,80},{290,50},{-250,100}}}
			},
			{
			--	{50,1,250,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
			}	
		...
		Y=
		{
			...
			{
				{400,1,1000,0,3,0,{{3020,500},{2070,250},{260,40},{-250,100}}},
			},	
			{
				--{200,1,1000,0,0,0,{{3020,500},{2070,250},{260,40},{-250,100}}},
			--	{50,1,250,1,1,0,{{2550,140},{1220,50},{620,80},{-250,100}}},
	...
	local b100,c100=0x1.233b,-0x.52d4
		...
		function unpack_phoneme(p)
			...
			if stress then
				return phone[sub(p,1,#p-1)],stress
			else
				return phone[p],0
			end 
		end
		function say(speech)
			...
			for i=1,#phonemes do
				local p,stress=unpack_phoneme(phonemes[i])
				next_p=unpack_phoneme(phonemes[i+1])
				next_silence=type(next_p)=="number"
				if (next_silence) next_p={{{1,0,0,0,0,0,{},{},{}}}}
				if type(p)=="number" then
					--add(sounds,{p*1200+p*rnd(240),0,0,0,0,0,{},{},{},0,{}})
					add(sounds,{p*1200,0,0,0,0,0,{},{},{},0,{}})
					onset,coda=1,1
				else
					...
					for section=2-onset,#p-coda do
						for frame in all(p[section]) do
							...
							if  not cascade then  -- get hh cascade
								c1=next_p[1][1][7]  --get cascade from first frame of next phoneme
								c2=c1
							end
							if (#c1 != #c2) c1=cascade
							v2=volume
...
say"SH IY1 _ S EH1 L Z _ S IY1 _ SH EH2 L Z _ AA1 N _ DH AH0 _ S IY1 _ SH AO0 ER0 ."
...
--ay"M AY1 T IY0 . P AE1 M . L EH1 M AH0 N ."

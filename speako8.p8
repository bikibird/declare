...
phone=
{
	AA=
	{
		...
		{
			{76,{1,500,0,0,{{2600,160},{1220,70},{700,130},{-250,100}}},0}
		},
		{
			{380,{1,500,4,2,{{2600,160},{1220,70},{700,130},{-250,100}}},0}
		},
		{
			{127,{1,500,4,0,{{2600,160},{1220,70},{700,130},{-250,100}}},0}
		},
	...
	AE=
	{
		...
		{
			{76,{1,500,0,0,{{2430,320},{1660,150},{620,170},{-250,100}}},0},
		},
		{
			{380,{1,1000,4,2,{{2430,320},{1660,150},{620,170},{-250,100}}},0}
		},
		{
			{127,{1,500,4,0,{{2430,320},{1660,150},{620,170},{-250,100}}},0}
		},
	...
	{
		{
			{136,{1,500,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}},0}
		},
		{
			{380,{1,1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
		},	
		{
			{227,{1,500,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}},0}
		},
	...
	{
		{
			{76,{1,500,0,0,{{2570,80},{990,100},{600,90},{-250,100}}},0}
		},
		{
			{380,{1,1000,4,2,{{2570,80},{990,100},{600,90},{-250,100}}},0},
		},	
		{
			{127,{1,500,4,0,{{2570,80},{990,100},{600,90},{-250,100}}},0}
		}
	},
	AW= 
	{
		{
			{70,{1,500,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}},0}
		},
		{
			{350,{1,1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
			{350,{1,1000,4,0,{{2960,400},{2020,100},{310,70},{-250,100}}},0},
		},	
		{
			{117,{1,500,4,0,{{2350,80},{900,70},{450,80},{-250,100}}},0}
		},
	},
	AY=
	{
		{
			{70,{1,500,0,0,{{2550,200},{1200,70},{660,100},{-250,100}}},0},
		},	
		{
			{350,{1,1000,4,2,{{2550,200},{1200,70},{660,100},{-250,100}}},0},
			{350,{1,1000,4,2,{{2550,200},{1880,100},{400,70},{-250,100}}},0},
		},	
		{	
			{117,{1,500,4,0,{{2550,200},{1880,100},{400,70},{-250,100}}},0},
		}	
	},
	EH=
	{
		{
			{1,{1,500,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},0},
			{300,{1,1000,1,0,{{2520,200},{1720,100},{480,70},{-250,100}}},0},
		},
		{
			{400,{1,1000,4,4,{{2520,200},{1720,100},{480,70},{-250,100}}},0},
		},
		{
			{300,{1,500,1,0,{{2520,200},{1720,100},{480,70},{-250,100}}},0},
		}	
	},
	ER=
	{
		{
			{62,{1,500,0,0,{{1540,110},{1270,60},{470,100},{-250,100}}},0},
		},	
		{
			{310,{1,1000,4,2,{{1540,110},{1270,60},{470,100},{-250,100}}},0},
			{320,{1,1000,4,0,{{1540,110},{1310,60},{420,100},{-250,100}}},0},
		},	
		{
			{107,{1,500,4,0,{{1540,110},{1310,60},{420,100},{-250,100}}},0},
		}
	},
	EY= 
	{
		{
			{64,{1,250,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}},0},
		},	
		{
			{320,{1,500,4,2,{{2520,200},{1720,100},{480,70},{-250,100}}},0},
			{320,{1,500,4,0,{{2600,200},{2020,100},{330,50},{-250,100}}},0},
		},	
		{
			{107,{1,250,4,0,{{2600,200},{2020,100},{330,50},{-250,100}}},0},
		}	
	},	
	...
	{
		{
			{40,{1,500,0,0,{{2570,140},{1800,100},{400,50},{-250,100}}},0},
		},	
		{
			{400,{1,1000,4,2,{{2570,140},{1800,100},{400,50},{-250,100}}},0},
		},	
		{	
			{67,{1,500,4,0,{{2570,140},{1600,100},{470,50},{-250,100}}},0},
		}
	},
	IY= 
	{
		{
			{56,{1,500,0,0,{{2960,400},{2020,100},{310,70},{-250,100}}},0},
		},	
		{
			{560,{1,1000,4,2,{{2960,400},{2020,100},{310,70},{-250,100}}},0},
			
		},	
		{
			{93,{1,500,4,1,{{2960,400},{2070,100},{290,50},{-250,100}}},0},
		}	
	},
	OW= 
	{
		{
			{64,{1,500,0,0,{{2300,70},{1100,70},{540,80},{-250,100}}},0},
		},	
		{
			{320,{1,1000,4,2,{{2300,70},{1100,70},{540,80},{-250,100}}},0},
			{320,{1,1000,4,0,{{2300,70},{900,70},{450,80},{-250,100}}},0},
		},	
		{
			{107,{1,500,4,0,{{2300,70},{900,70},{450,80},{-250,100}}},0},
		}
	},
	OY=
	{
		{
			{70,{1,500,0,0,{{2400,130},{960,50},{550,60},{-250,100}}},0},
		},	
		{
			{350,{1,1000,4,2,{{2400,130},{960,50},{550,60},{-250,100}}},0},
			{350,{1,1000,4,2,{{2400,130},{1820,50},{360,80},{-250,100}}},0},
		},
		{
			{117,{1,500,4,0,{{2400,130},{1820,50},{360,80},{-250,100}}},0},
		}	
	},
	UH=
	{
		{
			{40,{1,500,0,0,{{2350,80},{1100,100},{450,80},{-250,100}}},0}
		},
		{
			{200,{1,1000,4,2,{{2350,80},{1100,100},{450,80},{-250,100}}},0},
			{200,{1,1000,4,0,{{2350,80},{1180,100},{500,80},{-250,100}}},0},
		},	
		{
			{67,{1,500,4,0,{{2350,80},{1180,100},{500,80},{-250,100}}},0},
		}	
	}, 
	UW=
	{
		...
		{
			{54,{1,500,0,0,{{2200,140},{1250,110},{350,70},{-250,100}}},0},
		},	
		{
			{270,{1,1000,4,2,{{2200,140},{1250,110},{350,70},{-250,100}}},0},
			{270,{1,1000,4,0,{{2200,140},{900,110},{320,70},{-250,100}}},0},
		},	
		{
			{90,{1,500,4,0,{{2200,140},{900,110},{320,70},{-250,100}}},0},
		}	
	...
	{
		{
			{100,{1,1000,0,0,{{2880,280},{1050,100},{310,50},{-250,100}}},0}
		},
		{
			{500,{1,1000,4,2.4,{{2880,280},{1050,100},{310,50},{-250,100}}},0}
		},
		{
			{500,{1,500,4,0,{{2880,280},{1050,100},{310,50},{-250,100}}},0}
		},
	},
	LL= --dark l formants are wrong right now.
	{
		...
		{
			{100,{1,1000,4,2,{{2880,280},{1050,100},{310,50},{-250,100}}},0},
			{200,{1,750,4,0,{{2880,280},{850,100},{470,50},{-250,100}}},0},
			{200,{1,350,4,0,{{2880,280},{850,100},{470,50},{-250,100}}},0},
			
		},	
		{
			{100,{1,350,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
		},
	...
	{
		{
			{130,{1,1000,0,0,{{2150,200},{1100,150},{400,300},{-450,100}}},0},
		},	
		{
			{250,{1,1000,4,2.4,{{2150,200},{1100,150},{400,300},{-450,100}}},0},
		},	
		{
			{130,{1,1000,4,0,{{2150,200},{1100,150},{400,300},{-450,100}}},0},
			{100,{1,500,0,.5,{{2550,140},{1800,50},{620,80},{-250,0}}},0},
		},
	},
	...
	{
		{
			{140,{1,1000,0,0,{{2600,170},{1600,100},{200,60},{-450,100}}},0},
		},	
		{
			{230,{1,1000,4,2.4,{{2600,170},{1600,100},{200,60},{-450,100}}},0},
	
		},	
		{
			{140,{1,1000,0,0,{{2600,170},{1600,100},{200,60},{-450,100}}},0},
		--	{100,{1,1000,0,0,{{2550,140},{1800,50},{620,80},{-250,0}}},0},
			{100,{1,500,0,.5,{{2550,140},{1800,50},{620,80},{-250,0}}},0},
		},
	},
	NG=
	{
		{
			{140,{1,500,0,0,{{2850,280},{1990,150},{200,60},{-450,0}}},0}
		},
		{
			{380,{1,500,4,2.4,{{2850,280},{1990,150},{200,60},{-450,0}}},0},
		},	
		{
			{140,{1,500,0,0,{{2850,280},{1990,150},{200,60},{-450,0}}},0},
			{100,{1,500,0,.5,{{2550,140},{1800,50},{620,80},{-250,0}}},0},
	...
	{
		{
			{100,{1,1000,0,0,{{1380,120},{1060,100},{310,70},{-250,100}}},0},
		},
		{
			{700,{1,1000,2,2,{{1380,120},{1060,100},{310,70},{-250,100}}},0},
		},	
		{
			{100,{1,800,1,0,{{1380,120},{1060,100},{310,70},{-250,100}}},0},
		}	
	},
	SCHWA=
	{
		{
			{10,{1,1000,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
		},	
		{
			{270,{1,1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
		},
		{
			{10,{1,1000,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
		}	
	},
	...
	S=
	{
		...
		{
			{450,{0,3.5,0,0,{{2530,200},{1390,80},{320,200},{-250,100}}},1},
		},
		{
		},
	},
	...
	Z=
	{
		...
		{
			{400,{1,500,4,0,{{2530,200},{1390,80},{320,200},{-250,100}}},1},
			
		},
		{
			
			{100,{1,100,1,1,{{2550,140},{1220,50},{620,80},{-250,100}}},0},
		},
	},
	CH=
	{
		...
		{
			{450,{0,3.5,0,0,{{2820,300},{1800,90},{350,200},{-250,100}}},1},
	...
	SH=
	{
		...
		{
			{1,{0,3,0,0,{{2750,300},{1840,100},{300,200},{-250,100}}},1},
			{550,{0,5,2,0,{{2750,300},{1840,100},{300,200},{-250,100}}},1},
	...
	DH=
	{
		...
		{
			{500,{1,1200,0,0,{{2540,200},{1290,90},{320,200},{-250,100}}},1},
...
local a100,a200=1-b100-c100,1-b200-c200
	...
	source=
	{
		[0]=function(volume) return volume end,
		...
		function(volume)  --[2] gausian noise for aspiration
			local n=0
			for i=1,16 do 
				n+=rnd()
			end
	...
	function phonate(speech)
		...
		function prepare(attack,d,c1,v1,stress,frication,_sourcing,volume,velocity,blend,cascade)
			...
			return {d,_sourcing,frication,v1,velocity*(v2-v1)/d,v2,c,f_glide,bw_glide,stress,c2},c2,v2
		end	
		...
		for i=1,#phonemes do
			...
			if type(p)=="number" then
				--{d,_sourcing,frication,v1,velocity*(v2-v1)/d,v2,c,f_glide,bw_glide,stress,c2},c2,v2
				add(sounds,{p*900+p*rnd(200),0,0,0,0,0,{},{},{},0,{}})
				attack,decay=1,1
			else
				if (i==#phonemes or type(phone[next_phoneme])=="number" or consonant[phonemes[i+1]]) decay=0
				for section=2-attack,#p-decay do
					?section
					for frame in all(p[section]) do
						local c,f_glide,bw_glide={},{},{}
						local sound={}
						d,params,frication=unpack(frame)
						sound,c_old,v_old= prepare(section==1,d,c_old,v_old,stress,frication,unpack(params))
						add(sounds,sound)
					end
				end	
				...
				for i=0,127 do
					...
					if current_sound then
						if duration <= 0 and current_sound then
							--duration,params,frication=unpack(current_sound)
							--{d,_sourcing,frication,v1,velocity*(v2-v1)/d,v2,c,f_glide,bw_glide,stress,c2}
							duration,sourcing,frication,v,v_step,v_max,cascade,f_step,bw_step,stress,c2=unpack(current_sound)
							w0=5512.5\(voicing_f0[stress or 1])
							t=0
						end
						sample=source[sourcing](v)
						for k,c in pairs(cascade) do
								sample=formant(sample,c)
								local _c2=c2[k]
								if (c[1]\10 !=_c2[1]\10) c[1]+=f_step[k] --increment frequency
								if (c[2]\10 != _c2[2]\10) c[2]+=bw_step[k] --increment bandwidth
						end
						if (frication>0) sample*= 1 - rnd(frication)

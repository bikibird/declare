...
phone=
{
	...
	{
		{
			{{136,2,1000,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}}},
			{{380,2,1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}}},
			{{227,2,1000,4,0,{{2550,140},{1220,50},{620,80},{-250,100}}}},
		}
	},
	AO=
	{
		{
			{{76,2,1000,0,0,{{2570,80},{990,100},{600,90},{-250,100}}}},
			{{380,2,1000,4,2,{{2570,80},{990,100},{600,90},{-250,100}}}},
			{{127,2,1000,4,0,{{2570,80},{990,100},{600,90},{-250,100}}}},
		}
	},
	AW= 
	{
		{
			{{70,2,1000,0,0,{{2550,140},{1220,50},{620,80},{-250,100}}}},
			{
				{350,2,1000,4,2,{{2550,140},{1220,50},{620,80},{-250,100}}},
	...
	{
		{
			{{70,2,1000,0,0,{{2550,200},{1200,70},{660,100},{-250,100}}}},
			{
				{350,2,1000,4,2,{{2550,200},{1200,70},{660,100},{-250,100}}},
	...
	{
		{
			{{62,2,1000,0,0,{{1540,110},{1270,60},{470,100},{-250,100}}}},
			{
				{310,2,1000,4,2,{{1540,110},{1270,60},{470,100},{-250,100}}},
	...
	{
		{
			{{64,2,1000,0,0,{{2520,200},{1720,100},{480,70},{-250,100}}}},
			{
				{320,2,1000,4,2,{{2520,200},{1720,100},{480,70},{-250,100}}},
	...
	{
		{
			{{40,2,1000,0,0,{{2570,140},{1800,100},{400,50},{-250,100}}}},
			{
	...
	{
		{
			{{56,2,1000,0,0,{{2960,400},{2020,100},{310,70},{-250,100}}}},
			{
				{560,2,1000,4,2,{{2960,400},{2020,100},{310,70},{-250,100}}},
	...
	{
		{
			{{64,2,1000,0,0,{{2300,70},{1100,70},{540,80},{-250,100}}}},
			{
				{320,2,1000,4,2,{{2300,70},{1100,70},{540,80},{-250,100}}},
	...
	{
		{
			{{70,2,1000,0,0,{{2400,130},{960,50},{550,60},{-250,100}}}},
			{
				{350,2,1000,4,2,{{2400,130},{960,50},{550,60},{-250,100}}},
	...
	{
		{
			{{40,2,1000,0,0,{{2350,80},{1100,100},{450,80},{-250,100}}}},
			{
				{200,2,1000,4,2,{{2350,80},{1100,100},{450,80},{-250,100}}},
	...
	{
		{
			{{54,2,1000,0,0,{{2200,140},{1250,110},{350,70},{-250,100}}}},
			{
				{270,2,1000,4,2,{{2200,140},{1250,110},{350,70},{-250,100}}},
	...
	{
		{
			{{1,2,1000,0,0,{{2880,280},{1050,100},{310,50},{-250,100}}}},
			{
				{100,2,1000,4,2,{{2880,280},{1050,100},{310,50},{-250,100}}},
				{200,2,750,4,0,{{2880,280},{850,100},{470,50},{-250,100}}},
			},	
			{
	...
	{
		{
			{{130,2,1000,0,0,{{2150,200},{1100,150},{400,300},{-450,100}}}},
			{
				{250,2,1000,4,2.4,{{2150,200},{1100,150},{400,300},{-450,100}}},
			},	
			{
				{130,2,1000,4,0,{{2150,200},{1100,150},{400,300},{-450,100}}},
	...
	{
		{
			...
			{
				{230,2,1000,4,2.4,{{2600,170},{1600,100},{200,60},{-450,100}}},
	...
	{
		{
			{{140,2,1000,0,0,{{2850,280},{1990,150},{200,60},{-450,0}}}},
			{
				{380,2,1000,4,2.4,{{2850,280},{1990,150},{200,60},{-450,0}}},
			},	
			{
	...
	{
		{
			...
			{
				{20,1,.06,0,0,{{2400,60},{2000,400}}},
				{460,1,.2,1,0,{{2400,60},{2000,400}}},
			},
			{
				{30,1,.2,0,0,{{2400,60},{2000,400}}},
				{30,2,1000,0,0,0,0,0,0,{{2550,140},{1800,50},{620,80},{-250,0}}},
			},
		}	
	},
	...
	{
		{
			...
			{{400,1,.002,0,0,{{2400,60},{2000,400}}}},
			{
				{30,1,.002,0,0,{{2400,60},{2000,400}}},
				{30,2,1000,0,0,{{2550,140},{1800,50},{620,80},{-250,0}}}
		...
		if #sounds >0 then
			while stat(108)<1920 do
				for i=0,127 do
					...
					_sample=0
					for j=1,#duration do
						sample[j]=source[sourcing[j]](j)
						for k,c in pairs(cascade[j]) do
							sample[j]=formant(sample[j],c)
							local _c2=c2[j][k]
							if (c[1]\10 != _c2[1]\10) c[1]+=f_step[k] --increment frequency
							if (c[2]\10!=_c2[2]\10) c[2]+=bw_step[k] --increment bandwidth
						end
						if (v[j]<v_max[j]) v[j]+=v_step[j]
						_sample=sample+sample[j]
					end	
